...
def ants_image_to_file(ants_img, template_header, spatial_header, file_name, segmentations=True, nifti=False, ants_header=None): 
	...
	if nifti:
		if segmentations:
			assert(ants_header is not None)
