...
def average_hausdorff_distance(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=1, **kwargs):
    ...
    return metric.ahd(test, reference, voxel_spacing, connectivity)
...
ALL_METRICS = {
    ...
    "Average (Modified) Hausdorff Distance": average_hausdorff_distance,
